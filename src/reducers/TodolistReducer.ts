...
export const TodolistReducer = (state: TodolistsType[], action: TsarType) => {
    switch (action.type) {
...
type TsarType = RemoveTodoListACType | AddTodoListACType | ChangeFilterACType | UpdateTodolistTitleACType
